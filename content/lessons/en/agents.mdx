...
An AI agent is a tool that can take a goal, inspect files or context, suggest steps, and sometimes run actions for you. A chatbot mainly answers. An agent can help do the work.
...
- Planning safe diagnostics, such as an Android ADB audit, before anything destructive happens.
